...
namespace Restly.iOS
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        public void Include(UILabel label)
        {
            ...
            var mutableAttributetText = new NSMutableAttributedString();
            mutableAttributetText.Append(new NSAttributedString("Your bold text"), UIFont.BoldSystemFontOfSize(15));
            mutableAttributetText.Append(new NSAttributedString("Your normal text"), UIFont.FromName("yout_font_name", 15));

            label.AttributedText = mutableAttributetText;
        }
